...
$.fn.dateSelect = function(options) {
	...
	var _dateBody = "<div class='tz-datepicker' id='datepicker_" + elem_id + "'>" +
		...
		"<span class='month'><span>6月</span><div class='month-list' id='mlist_" + elem_id +
		...
		"<span class='year'><span class='span-year'>2015</span><div class='year-list' id='ylist_" + elem_id +
	...
	$(document).bind("click", function(event) {
		...
		if (elem.id == "datepicker_" + elem_id || $(elem).parent()[0].id == "datepicker_" + elem_id || $(elem).parent().parent()[
				0].id == "datepicker_" + elem_id) {
			return;
		} else if (elem.id == "ym" + elem_id || $(elem).parent()[0].id == "ym" + elem_id || $(elem).parent().parent()[0].id ==
			"ym" + elem_id) {
			return;
		} else if (elem.id == "mlist_" + elem_id || $(elem).parent()[0].id == "mlist_" + elem_id || $(elem).parent().parent()[
				0].id == "mlist_" + elem_id) {
			return;
		} else if (elem.id == "ylist_" + elem_id || $(elem).parent()[0].id == "ylist_" + elem_id || $(elem).parent().parent()[
				0].id == "ylist_" + elem_id) {
			return;
		} else {
			if (isShow) {
